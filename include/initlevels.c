...
void bond_action(){
    ...
    correctAction[1].name = (char *)malloc(strlen("IF") + 1);
    strcpy(correctAction[1].name, "IF");
    correctAction[2].name = (char *)malloc(strlen("FINE_IF") + 1);
    strcpy(correctAction[2].name, "FINE_IF");
    ...
    correctAction[5].name = (char *)malloc(strlen("WHILE") + 1);
    strcpy(correctAction[5].name, "WHILE");
    correctAction[6].name = (char *)malloc(strlen("DO") + 1);
    strcpy(correctAction[6].name, "DO");
    correctAction[7].name = (char *)malloc(strlen("FOR") + 1);
    strcpy(correctAction[7].name, "FOR");
